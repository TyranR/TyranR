...
### CIO / IT Director
Помогаю GameDev-компаниям синхронизировать ИТ-инфраструктуру с целями бизнеса, масштабировать разработку и защищать интеллектуальную собственность.
...
* Для крупных GameDev-компаний: Беру на себя полное операционное и стратегическое управление ИТ-департаментом (от техподдержки до DevOps и SecOps).
