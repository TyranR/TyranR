...
* **Для стартапов и средних студий (Full-time / Проектно):** С нуля создаю эффективные ИТ-команды или перезапускаю текущие процессы. Настраиваю инфраструктуру под пайплайны разработки так, чтобы она помогала, а не мешала выпускать игры.
