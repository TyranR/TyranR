...
Разрабатываю и поддерживаю шаблоны мониторинга для Zabbix. Мои шаблоны, принятые в официальный репозиторий [Zabbix Community Templates](https://github.com/zabbix/community-templates/commits?author=TyranR):
