...
<details>
  <summary><b>Elephant Games</b> | Директор по информационным технологиям (CIO) (02.2023 — настоящее время)</summary>

  **Армения** | [elephant-games.com](https://elephant-games.com)  
  *Информационные технологии, системная интеграция, интернет*

  ### Ключевые достижения:

  * **Оптимизация IT-инфраструктуры:**
      * Осуществил масштабную миграцию серверной инфраструктуры из РФ в облако **AWS**.
      * Обновил устаревшее ПО и серверы, адаптировал приложения для работы в **Kubernetes**, обеспечив отказоустойчивость и масштабируемость.
  * **Проектное управление и CI/CD:**
      * Реализовал поэтапный перенос репозиториев (Gitea → Assembla → **GitLab**).
      * Провел миграцию с Jenkins и TeamCity на **GitLab CI/CD**, централизовав управление пайплайнами и ускорив процессы разработки.
  * **Автоматизация (IaC):**
      * Внедрил **Terraform** для автоматизации управления инфраструктурой и ресурсами в AWS.
  * **Оптимизация затрат и бюджетирование:**
      * Спланировал IT-бюджет на 2 года вперед с учетом рисков.
      * Снизил операционные расходы, заменив неэффективные решения более доступными альтернативами без потери функциональности.
  * **Управление командой:**
      * Руководил распределенной командой (**8+ человек**).
      * Выстроил процессы онбординга для DevOps-инженеров и других специалистов, сократив время их входа в проекты.
</details>
</details>
